...
public class Movement2D : MonoBehaviour // 5
{
	[SerializeField]
	...
	[SerializeField]
	private	LayerMask			groundLayer, groundBottomLayer;		// 바닥 체크를 위한 충돌 레이어
    ...
    public static bool isGroundedInfo;
    ...
    private void FixedUpdate()
	{
        ...
        isGroundedBottom = Physics2D.OverlapCircle(footPosition, 0.1f, groundBottomLayer);
		...
		{
			rigid2D.gravityScale = 3.0f;
		}

        isGroundedInfo = isGrounded;
